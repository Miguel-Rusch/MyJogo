...
public class tileMa{
    ...
    public void getTitleImages(){
        try {
            tile[1] = new tile();
            tile[1].image = ImageIO.read(getClass().getResourceAsStream("/Imagens/cenario/ceu.png"));

            tile[0] = new tile();
            tile[0].image = ImageIO.read(getClass().getResourceAsStream("/Imagens/cenario/plataforma.png"));
